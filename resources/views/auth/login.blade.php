...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="material-text  card-header">{{ __('LOGIN') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="material-text col-md-4 col-form-label text-md-right">{{ __('E-Mail Address') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password" class="material-text col-md-4 col-form-label text-md-right">{{ __('Password') }}</label>
