    ...
    <div id="hotel" class="container">
        ...
        <div class="row my-2">            
            ...
            <div class="col-lg">
                ...
                <?php echo Form::open(['url' => '/bookroom']); ?>
                ...
                <div class="d-flex justify-content-xl-around flex-wrap">
                    ...
                    <div class="p-2 mx-auto">
                        ...
                        <div class="form-inline">
                            ...
                            <?php echo e(Form::date('start_date', \Carbon\Carbon::tomorrow(), ['class' => 'form-control', 'id' => 'startDate'])); ?>
                    ...
                    <div class="p-2 mx-auto">
                        ...
                        <div class="form-inline">
                            ...
                            <?php echo e(Form::date('end_date', \Carbon\Carbon::tomorrow()->addDay(), ['class' => 'form-control', 'id' => 'endDate'])); ?>
                    ...
                    <div class="p-2 mx-auto">
                        <?php echo e(Form::select('room_type', $room_types_list , null, ['title' => 'Select Room Type', 'class' => 'border border-secondary rounded selectpicker', 'id' => 'selectRoomType', 'data-live-search' => 'true'])); ?>
                    ...
                    <div id="inputQuantityPanel" class="p-2 mx-auto d-none">
                        <div class="form-inline">                            
                            ...
                            <?php echo e(Form::number('quantity', 1, ['id' => 'inputQuantity', 'placeholder' => 'Input Number of Rooms', 'class' => 'form-control text-center'])); ?>                        
        ...
        <div class="row d-none" id="book-panel">
            ...
            <div class="col-lg">
                ...
                <?php if(auth()->guard()->guest()): ?>
                    ...
                    <a href="<?php echo e(url('/login')); ?>" class="btn btn-lg btn-primary btn-block my-2 rounded-0">
                ...
                <?php else: ?>                
                        ...
                        <a href="<?php echo e(url('/email/verify')); ?>" class="btn btn-lg btn-primary btn-block my-2 rounded-0">
                        ...
                        <?php else: ?>
                            ...
                            <?php if(is_null(auth()->user()->client->dob) ||
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="form-group p-2">                                            
                                        ...
                                        <div class="input-group mb-3">
                                                ...
                                                <?php echo e(Form::number('amount', '', ['step' => '50','id' => 'inputAmount', 'min' => '1', 'class' => 'form-control', 'required' => 'required'])); ?>

                                                <?php echo e(Form::hidden('hidden', '', ['id' => 'hiddenAmount'])); ?>
       ...
       <?php if(!is_null(\App\Models\RoomType::first())): ?>
            ...
            <div class="row d-flex flex-wrap">
                ...
                <?php $__currentLoopData = \App\Models\RoomType::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="border text-center mx-auto my-2 p-2" style="background-color: rgba(82, 53, 27, 0.295) !important;">
                        ...
                        <img data-enlargeable style="max-height: 300px; max-width:300px; cursor: zoom-in;" src="<?php echo e(url('storage/images/room_types/' . $room_type->images)); ?>" alt="" class="img-thumbnail border border-secondary">

                        <h2 class="material text" style="color:rgb(153, 153, 153) !important;"><?php echo e(strtoupper($room_type->desc)); ?></h2>
                        <h5 class="material text">&#8369;<?php echo e(number_format($room_type->rate, 2)); ?>/night</h5>   
                        
                        <?php if(!empty($room_type->persons_fit)): ?>

                            <?php $__currentLoopData = $room_type->beds_attr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bed): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <h6 class="material text" style="font-family: 'Allison', cursive !important; font-size: 2rem !important;"><?php echo e(ucfirst($bed->desc)); ?></h6>   
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
                            
                            <h6 class="material text">for <?php echo e($room_type->persons_fit); ?> Adults</h6>   
                            
                        <?php endif; ?>

                        <?php $__currentLoopData = $room_type->features(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            
                            <div class="text-center">
                                <span class="text-muted"><i class="fa fa-circle text-dark align-middle" style="font-size: .4rem;" aria-hidden="true"></i> <?php echo e($feature->desc); ?></span>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\soj-app\resources\views/hotel.blade.php ENDPATH**/ ?>